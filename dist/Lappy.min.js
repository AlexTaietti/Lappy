...
/***/ "./src/ActiveOverlapObject.js":
/*!************************************!*\
  !*** ./src/ActiveOverlapObject.js ***!
  \************************************/
/*! exports provided: ActiveOverlapObject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActiveOverlapObject", function() { return ActiveOverlapObject; });
/* harmony import */ var _Util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Util.js */ "./src/Util.js");
/* harmony import */ var _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BasicOverlapObject.js */ "./src/BasicOverlapObject.js");
...
var ActiveOverlapObject = /*#__PURE__*/function (_BasicOverlapObject) {
  ...
  _createClass(ActiveOverlapObject, [{
    ...
    value: function updateCoordinates() {
      this.htmlCoordinates = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].getInnerCoords(this.HTML);
      this.coordinates = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].getOuterCoords(this.HTML, this.offset, this.axis);
      ...
      if (NodeList.prototype.isPrototypeOf(overlapObject)) {
        for (var i = 0; i < overlapObject.length; i++) {
          this.trackedObjects.push({
            object: overlapObject instanceof _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__["BasicOverlapObject"] ? overlapObject : new _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__["BasicOverlapObject"](overlapObject[i], options),
            callbacks: _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].mergeObjects(_defaultCallbacks, callbacks),
            lastOverlapData: {
              x: null,
              y: null
            }
        ...
        this.trackedObjects.push({
          object: overlapObject instanceof _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__["BasicOverlapObject"] ? overlapObject : new _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__["BasicOverlapObject"](overlapObject, options),
          callbacks: _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].mergeObjects(_defaultCallbacks, callbacks),
          lastOverlapData: {
            x: null,
            y: null
...
}(_BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__["BasicOverlapObject"]);

/***/ }),

/***/ "./src/BasicOverlapObject.js":
/*!***********************************!*\
  !*** ./src/BasicOverlapObject.js ***!
  \***********************************/
/*! exports provided: BasicOverlapObject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BasicOverlapObject", function() { return BasicOverlapObject; });
/* harmony import */ var _Util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Util.js */ "./src/Util.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var BasicOverlapObject = /*#__PURE__*/function () {
  function BasicOverlapObject(htmlElement) {
    ...
    this.active = false;
    this.htmlCoordinates = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].getInnerCoords(htmlElement);
    this.coordinates = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].getOuterCoords(htmlElement, this.offset, this.axis);
...
/***/ "./src/GraphicalTest.js":
/*!******************************!*\
  !*** ./src/GraphicalTest.js ***!
  \******************************/
/*! exports provided: GraphicalTest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GraphicalTest", function() { return GraphicalTest; });
/* harmony import */ var _Util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Util.js */ "./src/Util.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var GraphicalTest = /*#__PURE__*/function () {
  function GraphicalTest() {
    ...
    var completeOptions = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].mergeObjects(defaults, options); // context options (more coming soon!)
...
/*!**********************!*\
  !*** ./src/Lappy.js ***!
  \**********************/
/*! exports provided: Lappy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Lappy", function() { return Lappy; });
/* harmony import */ var _Util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Util.js */ "./src/Util.js");
/* harmony import */ var _GraphicalTest_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GraphicalTest.js */ "./src/GraphicalTest.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Lappy = /*#__PURE__*/function () {
  function Lappy() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        graphicalTest = _ref.graphicalTest;

    _classCallCheck(this, Lappy);

    if (graphicalTest) this.graphicalTest = new _GraphicalTest_js__WEBPACK_IMPORTED_MODULE_1__["GraphicalTest"](graphicalTest);
    this.overlapObjects = [];
  ...
  _createClass(Lappy, [{
    ...
    value: function resizeGraphicalTestCanvas() {
      this.graphicalTest.context.canvas.width = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].getDocumentWidth();
      this.graphicalTest.context.canvas.height = _Util_js__WEBPACK_IMPORTED_MODULE_0__["Util"].getDocumentHeight();
    }
  }, {
    key: "checkOverlapY",
    ...
    value: function addGraphicalTest(graphicalTestData) {
      if (!this.graphicalTest) {
        this.graphicalTest = new _GraphicalTest_js__WEBPACK_IMPORTED_MODULE_1__["GraphicalTest"](graphicalTestData);
...
var Util = {
  ...
  mergeObjects: function (_mergeObjects) {
    function mergeObjects(_x, _x2, _x3) {
      return _mergeObjects.apply(this, arguments);
    }

    mergeObjects.toString = function () {
      return _mergeObjects.toString();
    };

    return mergeObjects;
  }(function (target, object, deep) {
  ...
  getInnerCoords: function getInnerCoords(element) {
    var coords = [],
  ...
  getOuterCoords: function getOuterCoords(element) {
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: BasicOverlapObject, ActiveOverlapObject, Lappy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BasicOverlapObject.js */ "./src/BasicOverlapObject.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BasicOverlapObject", function() { return _BasicOverlapObject_js__WEBPACK_IMPORTED_MODULE_0__["BasicOverlapObject"]; });

/* harmony import */ var _ActiveOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ActiveOverlapObject.js */ "./src/ActiveOverlapObject.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ActiveOverlapObject", function() { return _ActiveOverlapObject_js__WEBPACK_IMPORTED_MODULE_1__["ActiveOverlapObject"]; });

/* harmony import */ var _Lappy_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Lappy.js */ "./src/Lappy.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Lappy", function() { return _Lappy_js__WEBPACK_IMPORTED_MODULE_2__["Lappy"]; });
